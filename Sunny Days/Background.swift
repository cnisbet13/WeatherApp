...
class Background: UIView {
    ...
    override func drawRect(rect: CGRect) {
        ...
        //// Color Declarations
        var lightPurple: UIColor = UIColor(red: 0.900, green: 0.075, blue: 0.202, alpha: 1.000)
        var darkPurple: UIColor = UIColor(red: 0.200, green: 0.036, blue: 0.202, alpha: 1.000)
